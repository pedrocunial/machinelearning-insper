...
page.util.initPinBottomSubmitStep = function() {
  ...
  //therefore the pining function is bound to both events.
...
page.PageMenuToggler.prototype =
{
  ...
  initialize: function( isMenuOpen,key,temporaryScope )
  {
    ...
    // Close course menu if width is smaller than an iPad's width
    Event.observe(window, 'resize', this.collapseCourseMenuIfWidthTooSmall.bindAsEventListener( this ) );
  },
  ...
  isLessThanMinWidthToDisplayCourseMenu: function()
  {
    ...
    var minWidthToAutoCollapseInPx = 768;
