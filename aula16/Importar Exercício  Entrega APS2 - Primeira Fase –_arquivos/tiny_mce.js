	...
	tinymce.create('tinymce.dom.Selection', {
		...
		getBookmark : function(type, normalized) {
			...
			if (rng.duplicate || rng.item) {
				...
				rng.collapse(true);
        //BB code Begin for Lightbox, sometimes throws error
        try
        {
        //BB code end
...
(function(tinymce) {
	tinymce.dom.ScriptLoader = function(settings) {
        ...
        /** BB code Begin  missing locales can cause the CE to not load. always mark done so it will
         * at load and render the locale keys
         *
         * Also, search this file and replace all 'en' to 'en_US' as the default locale.
         * **/
         done();
         /** BB code end**/
			};
...
(function(tinymce) {
	...
	tinymce.create('tinymce.ui.KeyboardNavigation', {
      ...
      /** BB code Begin  Set the items for the Keyboard navigation**/
      t.setItems = function( lt )
      {
        items = lt;
      };
      t.setFocussedId = function ( fId )
      {
        focussedId = fId;
      };
      /** BB code End **/			
...
(function(tinymce) {
	...
	tinymce.create('tinymce.ui.ColorSplitButton:tinymce.ui.SplitButton', {
		...
		setColor : function(c) {
			this.displayColor(c);
      //BB Code Change Begin
      //in IE apply color first and hide menu later.
      if ( tinymce.isIE )
      {
...
(function(tinymce) {
  ...
  /** BB code Begin **/
  var ie7_compat_value = tinymce.isIE9 ? false : true;
  /** BB code End **/
	...
	tinymce.create('tinymce.Editor', {
      ...
      //BB code begin
      if ( s.is_aria_required ) {
        s.aria_label = s.aria_label + " " + t.getLang('aria.required_field');
      }
      //BB code end
			if (s.theme) {
        ...
        else //BB Code Begin -- load *.rtl.css file in case directionality is 'rtl'
        {
          if (t.settings.directionality == "rtl")
          {
            s.popup_css = t.baseURI.toAbsolute("themes/" + s.theme + "/skins/" + s.skin + "/dialog_rtl.css");
          }
          else
          {
	    ...
	    //BB Code Begin -- Added vtbegenerated class 
      if ( e.title === null || e.title === "" )
			{
        t.iframeHTML += '</head><body id="' + bi + '" class="mceContentBody ' + bc + ' vtbegenerated" onload="window.parent.tinyMCE.get(\'' + t.id + '\').onLoad.dispatch();"><br></body></html>';
			}
			else
			{
			  t.iframeHTML += '</head><body id="' + bi + '" class="mceContentBody ' + bc + ' vtbegenerated" title="' + e.title + '" onload="window.parent.tinyMCE.get(\'' + t.id + '\').onLoad.dispatch();"><br></body></html>'; 
			}
      ...
      //BB Code End
			...
			n = DOM.add(o.iframeContainer, 'iframe', { 
				...
				title : s.aria_label,
				'aria-required' : s.is_aria_required, //BB-Code Change
				style : {
					width : '100%',
					height : h,
		...
		initContentBody : function() {
	      ...
	      //BB Code Begin -- Added vtbegenerated class 
        DOM.addClass(targetElm, 'mceContentBody vtbegenerated');
        //BB Code End
		...
		translate : function(s) {
			var c = this.settings.language || 'en_US', i18n = tinymce.i18n;
		...
		getLang : function(n, dv) {
			return tinymce.i18n[(this.settings.language || 'en_US') + '.' + n] || (is(dv) ? dv : '{#' + n + '}');
		},
        ...
        //BB Code Begin -- Added it for the removing the html for the simple VTBE
        if ( typeof(htmlToText) == "function" && t.plugins.bb_simple )
        {
          h = htmlToText ( h, true );
        }
        //BB Code End
...
tinymce.ForceBlocks = function(editor) {
	...
	function addRootBlocks() {
      ...
      //Bb code begin - IE issue only, the while test isn't capturing that node
      //is null and when node.nodeName is called an exception is thrown, LRN-54138.
      if (!node)
        return;
      //Bb code end
	...
	tinymce.Formatter = function(ed) {
		...
		function defaultFormats() {
			register({
				...
				removeformat : [
                        {selector : 'b,strong,em,i,font,u,strike,address,pre,h4,h5,h6', remove : 'all', split : true, expand : false, block_expand : true, deep : true},
                        /** BB code end **/
                        //as per EPHOX team suggestion added this configuration line to fix LRN-59948.
                        {selector : 'li,ol,ul', block : 'p', remove : 'all', split : false, expand : false, block_expand : false, deep : false},
