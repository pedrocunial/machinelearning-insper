...
widget.FilePicker.prototype =
{
                           ...
                           showSpecialAction, allowMultipleFiles, onAttachFile, allowMultipleLocalFileUpload )
    {
      ...
      { 
        ...
        $j( dropZoneArea ).bind( 'drop', $j.proxy( function( event ) {
          this.onLocalPick(event.originalEvent);
        }, this ) );
    ...
    /**
     * Creates a FormData object with the values of the specified form and also adds the local files to upload.
     * This FormData object is returned to the caller to submit via Ajax upload.
     */
